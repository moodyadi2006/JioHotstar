...
export default function Home() {
  ...
  return (
    <div className="bg-black w-100">
      ...
      <div>
        <h1 className="text-yellow-400 ml-5 font-extrabold text-5xl mb-5">
          Movies
        </h1>
                    ...
                    >
                      <div className="relative group w-48 h-64 border rounded-xl transition-all duration-300 ease-in-out hover:w-56 hover:h-72 hover:z-10">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-end p-4 transition-all duration-300 ease-in-out opacity-0 hover:opacity-100 bg-opacity-0 hover:-translate-y-0">
                          ...
                          <Button
                            onClick={() =>
                              handleWatch(movie.name || movie.title)
                            }
                ...
                {currentMoviesList.map((movie, index) => (
                  ...
                  >
                    <Link
                      ...
                      passHref
                    >
                      <div className="relative w-48 h-64 border rounded-xl transition-all duration-300 ease-in-out hover:w-56 hover:h-72 hover:z-10">
                        {/* Background Image */}
                        <div
                          className="absolute inset-0 bg-no-repeat bg-cover bg-center transition-all duration-300 ease-in-out"
                          style={{
            ...
            >
              <CarouselContent className="flex">
                {tvShowsAiringTodayList.map((movie, index) => (
                  ...
                  >
                    <Link
                      href={`/movies/${movie.title || movie.name}`}
                      passHref
                    >
                      <div className="relative group w-48 h-64 border rounded-xl transition-all duration-300 ease-in-out hover:w-56 hover:h-72 hover:z-10">
                        {/* Background Image */}
